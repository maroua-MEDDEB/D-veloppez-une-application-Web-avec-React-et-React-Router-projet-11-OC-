...
const Collapse = (props) => {
  ...
  const displayCollapseText = () => {
    setOpen(true);
  }; // fonction qui affiche le textDeCollpase
  const unDisplayCollapseText = () => {
    setOpen(false);
  }; // fonction qui désaffiche le textDeCollpase
      ...
      <div className="collapse_default">
        {
          ...
          !open ? (
            <button
              className="bouttonDown"
              type="button"
              onClick={displayCollapseText}
            >
            ...
            <>
              <button
                className="bouttonUp"
                type="button"
                onClick={unDisplayCollapseText}
              >
                <span> {props.title} </span>
                <RiArrowDropUpLine style={{ color: "var(--color--light)" }} />
              </button>
              <div className="collapse_text">{props.text}</div>
            </>
          )
        }
      </div>
      ...
      <div className="collapse_default">
        {
          ...
          !open ? (
            ...
            <>
              ...
              <div className="collapse_text">{props.description}</div>
            </>
          )
        }
      </div>
